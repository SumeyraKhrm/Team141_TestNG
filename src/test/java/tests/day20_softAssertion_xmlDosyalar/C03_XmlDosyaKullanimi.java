...
public class C03_XmlDosyaKullanimi {
    ...
    /*
        ...
        Smoke Test : Uygulamanın en hayati fonksiyonlarının günlük test edilmesi
        E2E Testi : Baslangıctan sona kadar tüm adımların test edilmesi
        Regression Test : Butun fonskiyonların sağlıklı calıştığını test etmek için tum classların calıştırılması
        ...
        TestNG istedigimiz konfigurasyonlarda istedigimiz sayida  package/class ve test method'unu toplu olarak calistirabilmemiz
        icin TestNG xml dosyalari hazirlamistir  !!

        TestNG kullanilarak toplu kod calistirmak istedigimizde .xml dosyalarini kullanabiliriz
