...
public class C01_SoftAssertions {
      ...
      /*
        SoftAssertion'da 3 adim var (verification)
        1- softAssert objesi olustur
        2- istenen tum assertion'lari softAssert objesini kullanarak yap
        3- assertion'lar bittikten sonra, softAssert'un rapor vermesi icin assertAll() calistir.
     */
    ...
    public void aramaTesti(){
        ...
        String actualUrunIsmi = testotomasyonuPage.
                ilkUrunSayfasindaUrunIsimElementi.getText().toLowerCase();
